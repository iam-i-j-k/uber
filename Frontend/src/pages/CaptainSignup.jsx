...
const CaptainSignup = () => {
  ...
  return (
    <div className='py-7 px-7 h-[93vh] flex flex-col justify-between'>
      ...
      <div>
        <p className='text-[10px] mt-6 leading-tight'>This site is protected by reCAPTCHA and the <span className='underline'>Goole Privacy Policy</span> and <span className='underline'>Terms of Service</span> </p>
      </div>
    </div>
  )
}
